...
export function KnowledgeHighlights() {
  ...
  return (
    <section id="knowledge" className="flex w-full max-w-5xl flex-col gap-3 pt-2 sm:pt-4">
      <div className="flex flex-col gap-1.5 px-2 sm:px-4">
        <AppLink to="/knowledge" className="group flex w-fit items-center gap-2">
...
function ViewAllCard({ className }: { className?: string }) {
  ...
  return (
    <AppLink to="/knowledge" className={cn("block h-full group", className)} aria-label={t("viewAllTitle")}>
